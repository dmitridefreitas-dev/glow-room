...
const RUNG_H = 23; // px of height per day (rung spacing) — compact enough to scan
const PAD = 18; //    on a phone, but tall enough that the day numbers stay legible
  ...
  return (
    ...
    >
      ...
      <span className="climber" style={{ top: todayY, left: "50%" }}>
        <Avatar stage={avatarStage} size={44} float={false} />
